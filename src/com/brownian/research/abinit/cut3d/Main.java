...
public class Main {
    ...
    private static void printUsageInformationTo(PrintStream stream){
        ...
        stream.println("\t"+PROGRAM_NAME+" [-v|--verbose] [-in] <input file>] [[-out] <output file>]\tConvert a file and output the result to stdout or the specified file");
        stream.println("\t"+PROGRAM_NAME+" [-h]\tDisplay this help message");
    }
